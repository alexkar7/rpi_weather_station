"""
TemperatureSensor class gets current humidity information using DHT11 and DHT22 sensors
"""
...
class TemperatureSensor(object):
    ...
    def get_temperature(self):
        ...
        temperature = {
            'dht11': self.dht11_sensor.get_temperature(),
            'dht22': self.dht22_sensor.get_temperature()
        }
